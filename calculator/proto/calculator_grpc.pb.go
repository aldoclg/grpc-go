...
type CalculatorServiceClient interface {
	...
	Decompose(ctx context.Context, in *DecompositionRequest, opts ...grpc.CallOption) (CalculatorService_DecomposeClient, error)
...
func (c *calculatorServiceClient) Decompose(ctx context.Context, in *DecompositionRequest, opts ...grpc.CallOption) (CalculatorService_DecomposeClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/calculator.CalculatorService/Decompose", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorServiceDecomposeClient) Recv() (*CalculatorResponse, error) {
...
func (x *calculatorServiceMaxClient) Recv() (*CalculatorResponse, error) {
	m := new(CalculatorResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CalculatorServiceServer interface {
	...
	Decompose(*DecompositionRequest, CalculatorService_DecomposeServer) error
...
func (UnimplementedCalculatorServiceServer) Decompose(*DecompositionRequest, CalculatorService_DecomposeServer) error {
...
func (x *calculatorServiceDecomposeServer) Send(m *CalculatorResponse) error {
...
func (x *calculatorServiceMaxServer) Send(m *CalculatorResponse) error {
	return x.ServerStream.SendMsg(m)
}
